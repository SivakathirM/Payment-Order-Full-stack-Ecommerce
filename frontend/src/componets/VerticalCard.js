          ...
          
        {
            loading ? (
                loadingList.map((product,index)=>{
                    return(
                        <div className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-sm shadow'>
                            <div className='bg-slate-300 h-48 min-w-[280px] md:min-w-[145px] p-4 flex items-center justify-center animate-pulse' key={product+index+"product"}>
                ...
                data.map((product,index)=>{
                    return(
                        <Link to={"/product/"+product?._id}  className='w-full min-w-[280px] md:min-w-[300px] max-w-[280px] md:max-w-[300px] bg-white rounded-sm shadow' onClick={scrollTop} key={product+index+"product"}>
